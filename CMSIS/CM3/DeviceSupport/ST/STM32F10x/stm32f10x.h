...
typedef enum {REQ_ERROR = 0, SUCCESS = !REQ_ERROR} ErrorStatus;
...
#define ETH_DMATPDR_TPD      ((uint32_t)0xFFFFFFFF)  /* Transmit pool demand */

/* Bit definition for Ethernet DMA Receive Poll Demand Register */
#define ETH_DMARPDR_RPD      ((uint32_t)0xFFFFFFFF)  /* Receive pool demand  */
